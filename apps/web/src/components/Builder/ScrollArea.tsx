...
export function ScrollArea(props: { children: React.ReactNode }) {
  return (
    <RadixScrollArea.Root className="h-full overflow-hidden">
      ...
      >
        <RadixScrollArea.Thumb className="bg-mauve10 relative flex-1 rounded-[10px] before:absolute before:top-1/2 before:left-1/2 before:h-full before:min-h-[44px] before:w-full before:min-w-[44px] before:-translate-x-1/2 before:-translate-y-1/2 before:content-['']" />
      </RadixScrollArea.Scrollbar>
